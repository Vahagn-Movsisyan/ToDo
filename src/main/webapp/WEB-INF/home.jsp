                ...
                <form action="/add" method="post">
                    ...
                    <div class="col-auto m-0 px-2 d-flex align-items-center">
                        <label class="text-secondary my-2 p-0 px-1 view-opt-label due-date-label d-none">Due date not
                            set</label>
                        <input class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded"
                               type="date" placeholder="Add new .." name="finishDate">
                    </div>
    ...
    <div class="row m-1 p-3 px-5 justify-content-end">
        ...
        <div class="col-auto d-flex align-items-center px-1 pr-3">
            ...
            <select class="custom-select custom-select-sm btn my-2">
                ...
                <option value="due-date-desc"></option>
            </select>
            ...
            <div class="row px-3 align-items-center todo-item rounded">
                ...
                <div class="col px-1 m-1 d-flex align-items-center">
                    <input type="text"
                           ...
                           readonly value="<%=toDo.getTitle()%>" title="<%=toDo.getTitle()%>" name="title"/>
                </div>
                ...
                <div class="col-auto m-1 p-0 todo-actions">
                    <div class="row d-flex align-items-center justify-content-end">
                        <h5 class="m-0 p-0 px-2">
                            <a href="/update?id=<%=toDo.getId()%>"> <i class="fa fa-pencil text-info btn m-0 p-0"
                             data-toggle="tooltip" data-placement="bottom"
                             title="Edit todo"></i></a>
                        </h5>
                        <h5 class="m-0 p-0 px-2">
                            <a href="/delete?id=<%=toDo.getId()%>"><i class="fa fa-trash-o text-danger btn m-0 p-0"
                                data-toggle="tooltip"
